...
if (typeof materialReferenceUrl !== "string" || !materialReferenceUrl.includes("SRG181_")) {
  console.error("Expected the SRG181 physical material-card reference but received:", JSON.stringify(payload, null, 2));
  process.exit(1);
}
